...
My personal customization of the original [_arxiv_ style](https://github.com/kourgeorge/arxiv-style).
...
4. The only packages used in the style file are **geometry**, **hyperref**, **xcolor** and **fancyheader**. Do not reimport them!
